...
export const ContextProvider = (props) => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://database8080/best/Apps`)
            .then(res => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://database8080/best/Games`)
            .then(res => {
    ...
    useEffect(() => {
        axios.get(`http://database8080/latest/Apps`)
            .then(res => {
    ...
    useEffect(() => {
        axios.get(`http://database8080/latest/Games`)
            .then(res => {
